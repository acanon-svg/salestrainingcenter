...
export const DatabricksPanel: React.FC<DatabricksPanelProps> = ({
  ...
  const kpis = [
    ...
    },
    {
      ...
      value: metrics.tiempoPromedioEtapas ? `${metrics.tiempoPromedioEtapas} dÃÂ­as` : "Ã¢â¬â",
      icon: Clock,
          ...
          <CardContent className="pt-4 pb-3 flex items-start gap-3">
            ...
            <div>
              ...
              <Button
                ...
                onClick={() => window.open(DATABRICKS_URL, "_blank")}
              >
                Abrir dashboard directamente Ã¢â â
              </Button>
            </div>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader className="py-3 px-4">
          <CardTitle className="text-sm font-semibold text-gray-700 flex items-center gap-2">
            ...
            Dashboard de Productividad Ã¢â¬â Databricks
