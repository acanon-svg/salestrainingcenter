...
import { useCourseTags, CourseTag } from "@/hooks/useCourseTags";
import { CourseTagManager } from "./CourseTagManager";
...
export const CourseTagSelector: React.FC<CourseTagSelectorProps> = ({
  selectedTags,
  onChange,
}) => {
  ...
  return (
    <div className="space-y-2">
      ...
      <CourseTagManager open={isTagManagerOpen} onOpenChange={setIsTagManagerOpen} />
    </div>
  );
};
