                  ...
                  {enrollment.status === "completed" && (
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        size="sm"
                        variant="outline"
                        className="gap-2 border-green-500 text-green-600 hover:bg-green-50 dark:hover:bg-green-950 animate-[pulse_2s_cubic-bezier(0.4,0,0.6,1)_infinite] hover:animate-none transition-all hover:scale-105 shadow-md hover:shadow-lg"
                        onClick={async () => {
                      ...
                      >
                        ...
                        <span className="flex flex-col items-start leading-tight">
                          <span className="font-semibold">Recomendar</span>
                          <span className="text-[10px] opacity-80">🏆 ¡Gana 5 puntos!</span>
                        </span>
                      </Button>
                    </div>
                  )}
